...
export default function ResultsDefaultDisplay(props) {
  //==> passes in entire links [obj] as results (same as StackList init)
  const results = props.links
