                            ...
                            <div className="sm:flex-1">
                                <div className="leading-3">
                                    <div className="flex ml-5">
                                        <h3 className="font-semibold italic text-base text-gray-650 sm:text-2xl pb-3">{props.aboutInfo.username}</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="sm:px-0 sm:pt-0">
                        <dl className="space-y-8 px-4 sm:px-6 sm:space-y-6">
                            ...
                            <div className="mx-5">
                                ...
                                <dd className="text-sm text-gray-900 sm:col-span-2">{props.aboutInfo.location}</dd>
                            </div>
