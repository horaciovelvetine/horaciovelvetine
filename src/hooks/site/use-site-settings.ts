 ...
 *   - useMobileCompatibility: Boolean indicating if mobile compatibility mode is enabled
 *   - deviceInfo: Information about the client device and its capabilities
...
export function useSiteSettings(): SiteSettings {
	...
	const { useMobileCompatibility, deviceInfo } =
		useClientDeviceCompatibilityDetails();
