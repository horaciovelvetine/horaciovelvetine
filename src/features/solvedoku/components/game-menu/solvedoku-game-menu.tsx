    ...
    <ul className='flex flex-col w-full tracking-tighter gap-2 px-8 mb-6'>
      ...
      <li className='flex justify-center items-center w-full'>
        <div className='flex flex-col items-center my-1 md:my-2 '>
          ...
          <p className='text-2xs leading-4 xs:w-2/3 md:text-sm md:leading-5 text-white/50 text-center tracking-tight'>
            The difficulty determines the number of cells which remain filled when
